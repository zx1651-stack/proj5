...
constexpr int LEVEL2_SCORE_LINE = 370;

// L3
constexpr float VIRUS_MOVE_FIRST_SPAWN_TIME = 20.0f;
constexpr float VIRUS_MOVE_RESPAWN_INTERVAL = 10.0f;
constexpr float VIRUS_MOVE_OFFSET_DISTANCE  = 450.0f;
constexpr float VIRUS_MOVE_SPEED_FACTOR     = 0.8f;
constexpr float VIRUS_MOVE_SCALE            = 0.30f;
constexpr float VIRUS_MOVE_COLLIDER_SCALE   = 0.9f;
...
Level2Scene::Level2Scene(Vector2 origin, const char *bgHexCode)
...
void Level2Scene::render()
{
    ...
    DrawText(TextFormat("%d", LEVEL2_SCORE_LINE), 20 + lw + 10, 80, fs, WHITE);
